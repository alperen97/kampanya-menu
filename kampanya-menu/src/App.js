...
import DetayPage from "./components/kampanya_detay/detay";
...
import BagisPage from "./components/bagis/bagisFirst"
import ErrorPage from "./components/error/errorPage"
import IstPage from "./components/istatistikler/istatistikPage"
import StoryDetayPage from "./components/story/storyFirst"
...
function App() {
  ...
  return (
    <div className="cardStyle">
      <div>
        <Card border="dark" style={{ width: "28rem", borderRadius: "0px" }}>
          <BrowserRouter>
            <Switch>
